...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/04 15:29:45 by skedikia          #+#    #+#             */
/*   Updated: 2024/05/04 15:32:01 by skedikia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	* remove_last_enter - returns new string, but
	* 					  without last character if it was '\n'.
*/
...
/*
	...
	* check_str_size - returns true if 'str' length is ok,
	* 				   else returns false. 
	* check_line_spacing - returns true if file_content line is ok,
	* 					   else returns false.
	* check_value_size - returns true if 'num' value fits in size of INT,
	* 					 else returns false.
	* check_file_name - returns true if file_name is ok,
	* 					else returns false.
*/
...
/*
	...
	* render_error - exit with message of issue while trying
	* 			     to render the landscape. 
	* usage_arguments - exit and explaining how to use program
	* 				    arguments properly.
	* usage_file_values - exit and explaining what values
	*    				  file must have.
	* usage_file_content - exit and explaining what must file
	* 					   content have.
	* exit_with_error - exit with code 1 and also shows given
	* 				    str text.
*/
