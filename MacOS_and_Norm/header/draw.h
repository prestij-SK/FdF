...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/04 15:33:39 by skedikia          #+#    #+#             */
/*   Updated: 2024/05/08 13:54:09 by skedikia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	* draw_line_Bresenham - draws a line on the 'img' from (x1, y1) to
	* 						(x2, y2) with Bresenham Algorithm.
	* draw_line_Bresenham_random_colors - does same line drawing but with
	* 									  random coloring on diagonals.
	* draw_landscape_vertical_lines - draws vertical lines coordinates of
	* 								  'land_data' to 'land_table' image.
	* draw_landscape_horizontal_lines - draws horizontal lines coordinates of
	* 									'land_data' to 'land_table' image.
*/
...
/*
	...
	setup_line_3D - initializes 'line' fields with given 'start' and
				    'end' coordinates for 3D plane.
*/
