...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/04 15:07:57 by skedikia          #+#    #+#             */
/*   Updated: 2024/05/04 15:08:43 by skedikia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
	...
	* get_z_level_color - every level of landscape will have a color,
	* 					  this function just chooses it by 'z_val'.
	* set_rgb - set 'rgb_color' r,g,b fields to 'color' first,
	* 			second and third 8 bits
	* line_fraction - counting fraction for current pixel index
	* 				  on the line (interpolation)
